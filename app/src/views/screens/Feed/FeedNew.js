...
function Feed({route, navigation}) {
  ...
  const detectSubscription = async (author_id, user_id, title) => {
    ...
    // setloading(true)
    var InsertAPIURL =
      base_url + '/news_subscription/detectSubscriptiononNews.php';
    var headers = {
      Accept: 'application/json',
      'Content-Type': 'application/json',
    };
    ...
    <SafeAreaView
        ...
        {value == true ? (
          ...
          <>
            ...
            <Dialog.Actions
              ...
              <Button color={COLORS.light} onPress={hideDialog}>
                Close
              </Button>
              <Button
                ...
                {language == 'en' ? 'Pay to View' : 'Pagar para ver'}
              </Button>
            </Dialog.Actions>
          </>
        )}
      ...
      <FAB.Group
        ...
        actions={[
          ...
          {
            icon: 'chess-king',
            label: language == 'en' ? 'Be The Owner' : 'Ser la dueña',
            color: COLORS.primary,
          ...
          },
          {
            icon: 'account',
            label:
              language == 'en' ? 'Become An Author' : 'Convertirse en autor',
            color: COLORS.primary,
      ...
      <View
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Icon name="tshirt" size={20} color={COLORS.secondary} />
            <Text
              style={{
              ...
              <TouchableOpacity
                ...
                <Text
                  style={{
                    ...
                    >
                  {language == 'en' ? 'All Category' : 'Todas las categorías'}
                </Text>
              </TouchableOpacity>
            ) : null
          }
        ...
        ref={flatListRef}
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                if (item.author_id != 0) {
                  ...
                  detectSubscription(item.author_id, user_id, item.title)
                }
                else {
                  navigation.navigate('webDetail', {
                    news_id: item.id,
              ...
              <View>
                ...
                resizeMode={FastImage.resizeMode.cover}
                  source={{
                    uri: image_url + item.thunbnail_link,
                ...
                >
                  {
                            ...
                            null :
                              ...
                              <Icon name="play" size={15} color={COLORS.primary}
                              style={{
                                position: 'absolute',
                                top: '45%',
                                left: '45%',
                  ...
                  style={{
                    ...
                    paddingHorizontal: 5,
                    paddingVertical: 5,
                    width:item.author_id != 0 ? width * 0.7 :  width * 0.85,
                  }}>
                  {item.title}
                </Text>
                  {
                                  item.author_id == 0 ? null : 
          ...
          // key extractor concvert the array into string
